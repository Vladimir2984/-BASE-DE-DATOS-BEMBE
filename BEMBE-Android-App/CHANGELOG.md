...
Esta versión agrega sincronización automática con servidor en la nube, logo institucional y horario completo de 7 días.

### ✨ Agregado

#### Sincronización en la Nube
- **Servidor Backend Node.js** con API REST completa
  - Autenticación JWT con tokens de 30 días
  - Encriptación bcrypt para contraseñas
  - Rate limiting y seguridad HTTPS
  - Base de datos PostgreSQL con Supabase (gratuito)

- **Sincronización automática** cada 5 minutos
  - Detección inteligente de conflictos
  - Sync bidireccional PC ↔ Móvil
  - Backups automáticos en la nube
  - Modo offline funcional

- **Indicador de estado de sync**
  - 💾 Modo Local (sin cuenta)
  - ☁️ Conectado (sync activa)
  - 🔄 Sincronizando...
  - ❌ Error Sync

#### Interfaz Mejorada
- **Logo institucional** en esquina superior izquierda
  - Imagen INCONO-BEMBE.png integrada
  - Tamaño 48x48 píxeles
  - Borde dorado con sombra
  - Visible en todo momento

- **Horario completo de 7 días** en Clases Bembe
  - Sábado: Práctica Libre (10:00-12:00)
  - Domingo: Clase Especial (18:00-20:00)

#### Configuración
- **4 nuevos botones** en Configuración:
...
- versionCode de 3 a 4
- Todas las funciones originales mantenidas (72 funciones)
- 7 nuevas funciones de sincronización agregadas
